...
const styles = StyleSheet.create({
  ...
  rankPill:{flex:1,minHeight:30,borderRadius:10,borderWidth:1,paddingHorizontal:8,flexDirection:'row',alignItems:'center',gap:5},
  ...
  menuList: { padding: 10, gap: 6, paddingBottom: 28 },
  item: { minHeight: 54, borderRadius: 14, borderWidth: 1, padding: 8, flexDirection: 'row', alignItems: 'center', gap: 10 },
  pressed: { opacity: .7 },
