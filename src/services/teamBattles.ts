...
export type TeamBattleSwitchOption = TeamBattleMember & { slot: number; disabled?: boolean | null };
...
export type TeamBattleState = {
  ...
  myPokemonId?: string | number | null;
  opponentPokemonId?: string | number | null;
  myHp?: number | string | null;
  myCurrentHp?: number | null;
  myMaxHp?: number | string | null;
  opponentHp?: number | string | null;
  opponentCurrentHp?: number | null;
  opponentMaxHp?: number | string | null;
  myTypes?: string[] | null;
