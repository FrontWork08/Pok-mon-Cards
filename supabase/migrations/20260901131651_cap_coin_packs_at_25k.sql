-- Cap all active coin boosters at 25,000 coins while preserving diamond prices.
-- Keep the 2,500 coin floor and 50% multiplier.
-- Shift price-aware quality thresholds down so booster quality is not reduced by the cap.
...
set coin_pack_ceiling=25000,
    notes=coalesce(notes,'{}'::jsonb) || jsonb_build_object(
      ...
      'boosterCoinPriceRelief','2026-09-01-ceiling-25k',
      'coinPackFloor',2500,
