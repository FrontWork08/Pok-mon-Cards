    ...
    <Screen title="Meus Decks" subtitle="Monte equipes com cards da sua Bag e deixe um deck principal pronto para batalhas.">
      ...
      <View style={styles.list}>
        {decks.map((deck) => {
          ...
          return <View key={deck.id} style={[styles.deck,{backgroundColor:colors.surface,borderColor:deck.is_default?colors.yellow:colors.border}]}>
...
const styles = StyleSheet.create({
  ...
  list:{gap:10},deck:{borderRadius:19,borderWidth:1,overflow:'hidden'},deckMain:{flexDirection:'row',alignItems:'center',gap:12,padding:13},preview:{width:96,height:80,flexDirection:'row',alignItems:'center',justifyContent:'center',borderRadius:13,overflow:'hidden'},previewCard:{width:48,height:67,borderRadius:5},deckInfo:{flex:1},nameRow:{flexDirection:'row',alignItems:'center',gap:7,flexWrap:'wrap'},deckName:{fontSize:16,fontWeight:'900'},deckMeta:{fontSize:10,marginTop:4},defaultBadge:{flexDirection:'row',alignItems:'center',gap:4,paddingHorizontal:7,paddingVertical:4,borderRadius:999},defaultText:{color:'#07111F',fontSize:7,fontWeight:'900'},deckActions:{minHeight:44,flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingHorizontal:13,paddingVertical:8,borderTopWidth:1},secondary:{flexDirection:'row',alignItems:'center',gap:6,paddingHorizontal:10,paddingVertical:8,borderRadius:10},secondaryText:{fontSize:8,fontWeight:'900'},deleteButton:{width:34,height:34,borderRadius:10,alignItems:'center',justifyContent:'center',backgroundColor:'#351A24'},empty:{alignItems:'center',gap:7,padding:28,borderRadius:19,borderWidth:1},emptyTitle:{fontSize:16,fontWeight:'900'},emptyText:{fontSize:11,textAlign:'center',maxWidth:420},
});
