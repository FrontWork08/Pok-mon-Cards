...
const styles = StyleSheet.create({
  ...
  rank: { fontSize: 15, fontWeight: '900', textShadowColor:'#000000F2', textShadowOffset:{width:0,height:1}, textShadowRadius:4 },
  identity: { flex: 1, minWidth: 0 },
  username: { fontSize: 15, lineHeight:20, fontWeight: '900', letterSpacing:.15, textShadowColor:'#000000FF', textShadowOffset:{width:0,height:1}, textShadowRadius:5 },
  coverage: { fontSize: 9, fontWeight:'700', marginTop: 4, textShadowColor:'#000000E6', textShadowOffset:{width:0,height:1}, textShadowRadius:3 },
  projectedReward: { fontSize: 8, fontWeight: '900', marginTop: 4, textShadowColor:'#000000E6', textShadowOffset:{width:0,height:1}, textShadowRadius:3 },
  valueWrap: { alignItems: 'flex-end' },
  valueLabel: { fontSize: 6, fontWeight: '900', letterSpacing: .5, marginBottom: 2, textShadowColor:'#000000E6', textShadowOffset:{width:0,height:1}, textShadowRadius:3 },
  value: { fontSize: 14, fontWeight: '900', textShadowColor:'#000000FF', textShadowOffset:{width:0,height:1}, textShadowRadius:4 },
});
