...
const styles = StyleSheet.create({passportHero:{borderRadius:17,borderWidth:1,padding:11,flexDirection:'row',alignItems:'center',gap:9,marginTop:12},passportIcon:{width:46,height:46,borderRadius:14,alignItems:'center',justifyContent:'center'},passportTitle:{fontSize:13,fontWeight:'900',marginTop:2},passportText:{fontSize:7.8,lineHeight:12,marginTop:2},lockCard:{borderRadius:16,borderWidth:1,padding:11,flexDirection:'row',alignItems:'center',gap:9,marginTop:12},lockTitle:{fontSize:10,fontWeight:'900'},lockText:{fontSize:7.5,lineHeight:11,marginTop:2},lockAction:{fontSize:7,fontWeight:'900'},passportTags:{flexDirection:'row',flexWrap:'wrap',gap:6,marginTop:10},passportTag:{borderRadius:999,borderWidth:1,paddingHorizontal:8,paddingVertical:6,flexDirection:'row',alignItems:'center',gap:4},passportTagText:{fontSize:6.5,fontWeight:'900'},timeline:{gap:6},timelineRow:{borderRadius:13,borderWidth:1,padding:8,flexDirection:'row',alignItems:'center',gap:8},timelineIcon:{width:34,height:34,borderRadius:10,alignItems:'center',justifyContent:'center'},timelineTitle:{fontSize:9,fontWeight:'900'},timelineMeta:{fontSize:6.8,marginTop:2},
  ...
  panelSectionTitle:{fontSize:15,fontWeight:'900',marginTop:16},
  gameTypeRow:{flexDirection:'row',flexWrap:'wrap',gap:7,marginTop:10},
  gameTypeChip:{minHeight:35,borderRadius:999,paddingHorizontal:10,flexDirection:'row',alignItems:'center',gap:5},
  gameTypeText:{color:'#FFFFFF',fontSize:7,fontWeight:'900',letterSpacing:.4},
  abilityCard:{borderRadius:14,borderWidth:1,padding:10},
  abilityName:{fontSize:13,fontWeight:'900',marginTop:3},
  moveList:{gap:7},
  moveCard:{minHeight:72,borderRadius:15,borderWidth:1,padding:9,flexDirection:'row',alignItems:'center',gap:9},
  moveTypeIcon:{width:39,height:39,borderRadius:20,alignItems:'center',justifyContent:'center'},
  moveBody:{flex:1,minWidth:0},
  moveTitleRow:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:7},
  moveName:{fontSize:11.5,fontWeight:'900',flexShrink:1},
  moveCategory:{fontSize:7,fontWeight:'900'},
  moveMeta:{fontSize:8,fontWeight:'800',marginTop:3},
  moveEffect:{fontSize:7.5,lineHeight:11,marginTop:2},
  contextAction:{marginTop:12,minHeight:62,borderRadius:15,borderWidth:1,padding:10,flexDirection:'row',alignItems:'center',gap:9},
  contextActionTitle:{fontSize:10.5,fontWeight:'900'},
  contextActionText:{fontSize:8,marginTop:2},
  contextGrid:{flexDirection:'row',flexWrap:'wrap',gap:7,marginTop:12},
  contextTile:{width:'48%',minHeight:52,borderRadius:14,borderWidth:1,padding:8,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:6},
  contextTileText:{fontSize:8,fontWeight:'900'},
  ...
  panelThemeWash:{...{ position: 'absolute', top: 0, right: 0, bottom: 0, left: 0 },opacity:.10,zIndex:0},
  ...
  cardThemeWash:{...{ position: 'absolute', top: 0, right: 0, bottom: 0, left: 0 },opacity:.065,zIndex:4},
  cardThemeEdge:{...{ position: 'absolute', top: 0, right: 0, bottom: 0, left: 0 },borderWidth:2,borderRadius:18,opacity:.72,zIndex:6},
