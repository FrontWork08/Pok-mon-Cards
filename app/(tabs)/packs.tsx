      ...
      <View style={[styles.shopHero, { backgroundColor: colors.accentSoft, borderColor: colors.accent }]}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={[styles.shopHeroText, { color: colors.muted }]}>
            Packs abaixo de US$ 800 continuam em Coins e ficam progressivamente mais caros conforme a chase card, chegando a até 🪙40.000. A partir de US$ 800, passam para Diamantes.
          </Text>
        </View>
      </View>
