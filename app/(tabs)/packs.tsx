...
export default function PacksScreen() {
  ...
  const artWidth = isMobile ? Math.min(230, Math.max(206, width - 112)) : width >= 1100 ? 162 : 174;
  const displayHeight = isMobile ? Math.round(artWidth * 1.62) : 315;
