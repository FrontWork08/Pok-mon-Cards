...
const styles=StyleSheet.create({
  ...
  panel:{borderRadius:20,borderWidth:1,padding:14,gap:11},panelHead:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',gap:10},sectionTitle:{fontSize:17,fontWeight:'900'},streak:{fontSize:18,fontWeight:'900'},primary:{minHeight:48,borderRadius:14,alignItems:'center',justifyContent:'center'},primaryText:{color:'#07111F',fontSize:10,fontWeight:'900'},stack:{gap:8},event:{minHeight:62,borderRadius:16,borderWidth:1,padding:11,flexDirection:'row',alignItems:'center',gap:10},eventIcon:{width:42,height:42,borderRadius:13,alignItems:'center',justifyContent:'center'},eventTitle:{fontSize:11,fontWeight:'900'},eventEffect:{fontSize:8.5,lineHeight:13,fontWeight:'700',marginTop:3},
