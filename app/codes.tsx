  ...
  return (
    <Screen title="Resgatar Código" subtitle="Cada código pode ser usado uma única vez por conta.">
      ...
      <View style={[styles.panel,{backgroundColor:colors.surface,borderColor:colors.border}]}>
        ...
        {result?<View style={[styles.success,{backgroundColor:'#15392A',borderColor:'#59D49A'}]}><Ionicons name="gift" size={22} color="#59D49A"/><View style={{flex:1}}><Text style={styles.successTitle}>Código {result.code} resgatado!</Text><Text style={styles.successText}>{rewardText(result.reward)}</Text></View></View>:null}
...
const styles=StyleSheet.create({
  ...
  success:{borderRadius:14,borderWidth:1,padding:12,flexDirection:'row',alignItems:'center',gap:9},successTitle:{color:'#D9FFEC',fontSize:12,fontWeight:'900'},successText:{color:'#AEF0CC',fontSize:9,marginTop:3},
