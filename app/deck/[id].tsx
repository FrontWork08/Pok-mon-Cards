  ...
  return <View style={[styles.safe, { backgroundColor: colors.bg }]}>
    ...
    <ScrollView contentContainerStyle={styles.content}>
      ...
      {loading ? <ActivityIndicator size="large" color={colors.yellow} /> : <>
        ...
        <Text style={[styles.helper, { color: colors.muted }]}>Cada versão pode aparecer até 4 vezes. O valor exibido usa o snapshot de mercado do TCGplayer.</Text>
        ...
        <Pressable style={styles.backButton} onPress={() => goBackOrHome(router)}><Text style={[styles.backText, { color: colors.muted }]}>VOLTAR AOS DECKS</Text></Pressable>
      </>}
    </ScrollView>
  </View>;
}
