...
export default function DeckEditorScreen() {
  ...
  const totalValue = useMemo(() => bag.reduce((sum, entry) => sum + Number(entry.cards?.game_value ?? 0) * Number(selected[entry.cards?.id ?? ''] ?? 0), 0), [bag, selected]);
