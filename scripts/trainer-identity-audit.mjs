...
const checks = [
  ...
  ['src/services/marketplace.ts', ['sellerAvatarPath', 'sellerAvatarUpdatedAt', 'sellerFrameId', 'sellerBackgroundId', "supabase.rpc('get_marketplace_hub_v2')"]],
  ['supabase/migrations/20260910120500_marketplace_hub_single_roundtrip.sql', ['avatar_path', 'avatar_updated_at', 'equipped_frame_id', 'equipped_background_id', "'sellerAvatarPath'", "'sellerFrameId'", "'sellerBackgroundId'"]],
